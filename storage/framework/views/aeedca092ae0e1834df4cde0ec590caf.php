    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('login.submit')); ?>">
            ...
            <div class="mb-2">
                ...
                <input type="email" name="email" class="form-control" value="<?php echo e(old('email','admin@nuclark.local')); ?>" placeholder="Enter your email" required>
            </div>
            <div class="mb-2">
        ...
        <a href="<?php echo e(route('register')); ?>" class="forgot">Create account</a>
        <div class="demo">Demo login: admin@nuclark.local / admin123</div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\Admin\Desktop\System Demo\resources\views/auth/login.blade.php ENDPATH**/ ?>