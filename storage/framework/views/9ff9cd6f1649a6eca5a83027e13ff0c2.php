...
<div class="module-head">
  <div>
    <h2 class="module-title">Mismatch Detection and Monitoring</h2>
    <div class="module-note">Scanning is performed exclusively through the mobile app by housekeeping/asset custodians (select Floor + Room, then scan the QR code). This page is a read-only monitoring view of everything they scan.</div>
  </div>
  <div>
    <a class="btn-soft small-btn" target="_blank" href="<?php echo e(route('asset-scans.print', request()->query())); ?>"><i class="bi bi-printer"></i> Print</a>
  </div>
</div>
...
<div class="page-tabs mb-3">
  <a href="<?php echo e(route('asset-scans.index', array_merge(request()->query(), ['filter' => 'all']))); ?>" class="<?php echo e($filter === 'all' ? 'active' : ''); ?>">All Scans</a>
  <a href="<?php echo e(route('asset-scans.index', array_merge(request()->query(), ['filter' => 'unresolved']))); ?>" class="<?php echo e($filter === 'unresolved' ? 'active' : ''); ?>">Unresolved Mismatches</a>
  <a href="<?php echo e(route('asset-scans.index', array_merge(request()->query(), ['filter' => 'resolved']))); ?>" class="<?php echo e($filter === 'resolved' ? 'active' : ''); ?>">Resolved</a>
  <a href="<?php echo e(route('asset-scans.index', array_merge(request()->query(), ['filter' => 'matched']))); ?>" class="<?php echo e($filter === 'matched' ? 'active' : ''); ?>">Matched</a>
</div>
...
<form method="GET" class="search-strip mb-3">
  ...
  <div class="filter-box"><i class="bi bi-building text-muted"></i><select name="floor" onchange="this.form.submit()">
    ...
    <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floorOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($floorOption->id); ?>" <?php if((string) $floorFilter === (string) $floorOption->id): echo 'selected'; endif; ?>><?php echo e($floorOption->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </select></div>
...
<div class="data-panel">
  ...
  <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <tr>
      ...
      <td class="table-actions">
        ...
        <?php endif; ?>
        <?php if($canDelete): ?>
        <form method="POST" action="<?php echo e(route('asset-scans.destroy', $log)); ?>" onsubmit="return confirm('Delete this scan record? This cannot be undone.');">
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><tr><td colspan="8" class="empty-state">No scan logs yet. Scans will appear here once housekeeping starts scanning assets on mobile.</td></tr><?php endif; ?>
  </tbody></table></div>
  <div class="mt-3"><?php echo e($logs->links()); ?></div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', ['title' => 'Asset Scan Monitoring'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/claude/webfix/capex-opex/resources/views/asset_scans/index.blade.php ENDPATH**/ ?>