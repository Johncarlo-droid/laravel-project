...
<div class="settings-list">
    ...
    <div class="settings-item"><h5>User Role Management</h5><p class="tiny mb-2">Assign admin, approver (dean/executive), and requestor access from the user management panel.</p><a href="<?php echo e(route('users.index')); ?>" class="btn-primaryx"><i class="bi bi-people"></i> Open User Management</a></div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', ['title' => 'Settings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\capex-opex-web-system\capex-opex\resources\views/settings/index.blade.php ENDPATH**/ ?>