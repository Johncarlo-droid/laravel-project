...
class ReportController extends Controller
{
    public function index()
    {
        ...
        $monthlyAcquisitions = Acquisition::selectRaw(\App\Support\DateSql::monthNumSelect('acquisition_date') . ' as month_num')
            ->selectRaw('SUM(quantity * unit_cost) as total_amount')
            ->groupByRaw(\App\Support\DateSql::monthNumGroupBy('acquisition_date'))
            ->orderBy('month_num')
            ->get();
