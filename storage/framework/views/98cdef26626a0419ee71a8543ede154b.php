...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .demo{margin-top:14px;font-size:11px;color:#8991A8;text-align:center;padding-top:12px;border-top:1px dashed #E7E9F2}
    </style>
</head>
<body>
<div class="wrap">
    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('login.submit')); ?>">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
                <div class="alert alert-danger py-2 px-3" style="font-size:12.5px;border-radius:10px;"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            <div class="mb-3">
                <label class="form-label">Email Address</label>
                <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="you@nuclark.local" required autofocus>
            </div>
            <div class="mb-3">
        ...
        <a href="<?php echo e(route('register')); ?>" class="forgot">Create an account →</a>
        <div class="demo">Demo: admin@nuclark.local / admin123</div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\Admin\Desktop\capex-opex-web-system\capex-opex\resources\views/auth/login.blade.php ENDPATH**/ ?>