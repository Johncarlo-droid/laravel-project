                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="role_select" class="form-control" required>
                                    ...
                                    <option value="requestor" @selected(old('role') === 'requestor')>Requestor (Student / Organization / Staff)</option>
                                    <option value="approver" @selected(old('role') === 'approver')>Approver (Adviser, Dean/Principal, SDAO, Academic Director, or Executive Director)</option>
                                    <option value="fmo" @selected(old('role') === 'fmo')>Facilities Management Office (FMO) Staff</option>
                                </select>
                            </div>
                            <div class="col-md-6 d-none" id="approver_type_wrap">
                                ...
                                <select name="approver_type" id="approver_type_select" class="form-control">
                                    ...
                                    <option value="adviser" @selected(old('approver_type') === 'adviser')>Adviser / Program Chair</option>
                                    <option value="dean" @selected(old('approver_type') === 'dean')>Dean / Principal</option>
                                    <option value="sdao" @selected(old('approver_type') === 'sdao')>SDAO</option>
                                    <option value="academic_director" @selected(old('approver_type') === 'academic_director')>Academic Director</option>
                                    <option value="executive" @selected(old('approver_type') === 'executive')>Executive Director</option>
                                </select>
                            </div>
                            <div class="col-12">
