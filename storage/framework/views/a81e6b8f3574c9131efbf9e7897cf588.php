...
<td class="text-end" data-label="Actions">
    ...
    <?php if(!$isOpex): ?>
        <a class="btn-soft small-btn" target="_blank" href="<?php echo e(route('api.items.qr', ['id' => $item->id])); ?>">
...
<?php echo $__env->make('layouts.admin', ['title' => $type === 'OPEX' ? 'OPEX Inventory' : 'CAPEX Inventory'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\System Demo\resources\views/items/index.blade.php ENDPATH**/ ?>