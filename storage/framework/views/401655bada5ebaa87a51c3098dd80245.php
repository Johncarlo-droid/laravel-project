    ...
    <div class="row g-0">
        <div class="col-lg-4">
            <div class="left-pane">
                ...
                <div class="mt-4"><a href="<?php echo e(route('login')); ?>" class="btn btn-light btn-sm">Back to login</a></div>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="right-pane">
                ...
                <div class="box">
                    ...
                    <form method="POST" action="<?php echo e(route('register.send-code')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3 align-items-end">
                            <div class="col-md-8">
                                <label class="form-label">Email address</label>
                                <input type="email" name="email" class="form-control" value="<?php echo e(old('email', old('verified_email', $verifiedEmail ?? ''))); ?>" placeholder="Enter your email" required>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="box">
                    ...
                    <?php if($verifiedEmail): ?>
                        <div class="mb-3"><span class="verified-badge">Verified: <?php echo e($verifiedEmail); ?></span></div>
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('register.verify-code')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6">
                                <label class="form-label">Verified email</label>
                                <input type="email" name="email" class="form-control" value="<?php echo e(old('email', old('verified_email', $verifiedEmail ?? ($pendingVerification['email'] ?? '')))); ?>" placeholder="Enter the same email" required>
                            </div>
                            <div class="col-md-3">
                    ...
                    <form method="POST" action="<?php echo e(route('register.submit')); ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Enter your full name" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" name="email" class="form-control" value="<?php echo e(old('verified_email', $verifiedEmail ?? '')); ?>" placeholder="Verified email only" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="role_select" class="form-control" required>
                                    ...
                                    <option value="requestor" <?php if(old('role') === 'requestor'): echo 'selected'; endif; ?>>Requestor (Student / Organization / Staff)</option>
                                    <option value="approver" <?php if(old('role') === 'approver'): echo 'selected'; endif; ?>>Approver (Adviser, Dean/Principal, SDAO, Academic Director, or Executive Director)</option>
                                    <option value="fmo" <?php if(old('role') === 'fmo'): echo 'selected'; endif; ?>>Facilities Management Office (FMO) Staff</option>
                                </select>
                            </div>
                            <div class="col-md-6 d-none" id="approver_type_wrap">
                                <label class="form-label">Approver Type</label>
                                <select name="approver_type" id="approver_type_select" class="form-control">
                                    <option value="">Select approver type</option>
                                    <option value="adviser" <?php if(old('approver_type') === 'adviser'): echo 'selected'; endif; ?>>Adviser / Program Chair</option>
                                    <option value="dean" <?php if(old('approver_type') === 'dean'): echo 'selected'; endif; ?>>Dean / Principal</option>
                                    <option value="sdao" <?php if(old('approver_type') === 'sdao'): echo 'selected'; endif; ?>>SDAO</option>
                                    <option value="academic_director" <?php if(old('approver_type') === 'academic_director'): echo 'selected'; endif; ?>>Academic Director</option>
                                    <option value="executive" <?php if(old('approver_type') === 'executive'): echo 'selected'; endif; ?>>Executive Director</option>
                                </select>
                            </div>
                            <div class="col-12">
                                <div class="muted mb-2" id="approval_note">Requestor accounts are activated immediately once your email is verified above. Approver and FMO accounts stay pending until an admin reviews and approves them.</div>
...
(function () {
    ...
    var wrap = document.getElementById('approver_type_wrap');
    var approverSelect = document.getElementById('approver_type_select');
    function sync() {
...
<?php /**PATH /home/claude/sys/capex-opex-main/resources/views/auth/register.blade.php ENDPATH**/ ?>