...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        User::updateOrCreate(
            ...
            ['department_id' => $amo->id, 'name' => 'System Super Admin', 'password' => bcryptSecure('super123'), 'role' => 'super_admin', 'approver_type' => null, 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
        User::updateOrCreate(
        ...
        $adviser = User::updateOrCreate(
            ...
            ['department_id' => $acct->id, 'name' => 'Student Org Adviser', 'password' => bcryptSecure('adviser123'), 'role' => 'approver', 'approver_type' => 'adviser', 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
        $sdao = User::updateOrCreate(
            ['email' => 'sdao@nuclark.local'],
            ['department_id' => $acct->id, 'name' => 'SDAO Officer', 'password' => bcryptSecure('sdao12345'), 'role' => 'approver', 'approver_type' => 'sdao', 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
        $academicDirector = User::updateOrCreate(
            ['email' => 'academicdirector@nuclark.local'],
            ['department_id' => $acct->id, 'name' => 'Priscilla M. Evangelista', 'password' => bcryptSecure('acaddir123'), 'role' => 'approver', 'approver_type' => 'academic_director', 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
        ...
        $fmoUser = User::updateOrCreate(
            ...
            ['department_id' => $fmoDept->id, 'name' => 'FMO Officer', 'password' => bcryptSecure('fmo12345'), 'role' => 'fmo', 'approver_type' => null, 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
        $housekeeping = User::updateOrCreate(
            ['email' => 'housekeeping@nuclark.local'],
            ['department_id' => $fmoDept->id, 'name' => 'Housekeeping Scanner', 'password' => bcryptSecure('house123'), 'role' => 'housekeeping', 'approver_type' => null, 'is_approved' => true, 'approved_at' => now(), 'email_verified_at' => now()]
        );
