<div class="row g-3">
  ...
  <div class="col-12 tiny text-muted">If set, the mobile app will verify asset scans near this room using real GPS distance instead of just comparing room names.</div>
