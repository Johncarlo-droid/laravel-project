...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .sidebar{width:112px;background:linear-gradient(180deg,var(--sidebar),var(--sidebar-2));color:#fff;position:sticky;top:0;height:100vh;border-right:1px solid rgba(255,255,255,.06);z-index:20;display:flex;flex-direction:column;overflow:hidden}
        .nav-list{padding:14px 8px;display:grid;gap:8px;overflow-y:auto;flex:1;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.25) transparent}
        .nav-list::-webkit-scrollbar{width:5px}
        .nav-list::-webkit-scrollbar-thumb{background:rgba(255,255,255,.25);border-radius:999px}
        .settings-list{display:grid;gap:14px;max-width:640px}
        .settings-item{background:#efefef;border:1px solid #cfd3dc;border-radius:16px;padding:16px 18px;box-shadow:0 6px 24px rgba(15,23,42,.07)}
        .settings-item h5{font-size:14px;font-weight:800;margin:0 0 6px}
        ...
        <div class="topbar">
            ...
            <div class="top-actions">
                ...
                <div class="user-chip">
                    ...
                    <div class="user-meta">
                        <div class="user-name"><?php echo e(auth()->user()->name ?? 'Christian Bundalian'); ?></div>
...
<?php /**PATH C:\Users\Admin\Desktop\System Demo\resources\views/layouts/admin.blade.php ENDPATH**/ ?>